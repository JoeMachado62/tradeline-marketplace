# OAGI Python SDK - LUX Computer Use Documentation
...
| ----------- | ------------------------------------------------------------------------------------ | ------------------------ |
| **Tasker**  | Strictly follows step-by-step instructions with ultra-stable, controllable execution | Pre-defined workflows    |
| **Actor**   | Ideal for immediate tasks, completing actions at near-instant speed                  | Quick, simple tasks      |
| **Thinker** | Understands vague, complex goals, performing hour-long executions                    | Complex multi-step goals |
...
| Package              | Description                                                                                                       |
| -------------------- | ----------------------------------------------------------------------------------------------------------------- |
| `oagi`               | Metapackage that includes all features (desktop + server). Equivalent to `oagi-core[desktop,server]`              |
...
- **GitHub Repository**: https://github.com/agiopen-org/oagi-python
